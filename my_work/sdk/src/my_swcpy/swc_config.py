...
load_dotenv() #load external environment variables
...
class SWCConfig:
    ...
    def __init__(
        ...
        swc_backoff: bool = True,
        swc_backoff_max: int = 30,
        swc_bulk_file_format: str = "csv",
    ):
        ...
        self.swc_base_url = swc_base_url or os.getenv("SWC-API_BASE_URL")
        ...
        self.swc_backoff = swc_backoff
        self.swc_backoff_max = swc_backoff_max
        self.swc_bulk_file_format = swc_bulk_file_format
    
    def __str__(self):
        """Stringify function to return contents of config object for logging"""
        return f"{self.swc_base_url} {self.swc_backoff} {self.swc_backoff_max} {self.swc_bulk_file_format}"
